...
const char* ei_classifier_inferencing_categories[] = { "idle", "rise", "wave" };

uint8_t ei_dsp_config_18_axes[] = { 0, 1, 2 };
const uint32_t ei_dsp_config_18_axes_size = 3;
ei_dsp_config_spectral_analysis_t ei_dsp_config_18 = {
    18, // uint32_t blockId
...
ei_model_dsp_t ei_dsp_blocks[ei_dsp_blocks_size] = {
    { // DSP block 18
        ...
        (void*)&ei_dsp_config_18, // pointer to config struct
        ei_dsp_config_18_axes, // array of offsets into the input stream, one for each axis
        ei_dsp_config_18_axes_size, // number of axes
        1, // version
...
const uint32_t ei_learning_block_4_inputs[1] = { 18 };
...
const ei_impulse_t impulse_536986_0 = {
    .project_id = 536986,
    .project_owner = "Zhe Chen",
    .project_name = "PoseDetection",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_536986_0 = ei_impulse_handle_t( &impulse_536986_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_536986_0;
